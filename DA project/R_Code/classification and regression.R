...
summary(mydata)
regreData=lm(TOTAL_MARKS~L1_Marks+L2_MARKS+L3_MARKS+S1_MARKS+S2_MARKS+S3_MARKS, data = mydata)
...
testData1=data.frame(L1 =testData$L1_z, L2 = testData$L2_z,
                     L3 = testData$L3_z, 
                     S2 = testData$S2_z, 
                     marksClass = testData$marksClass)

trainData1=data.frame(L1 = trainData$L1_z,L2 = trainData$L2_z,
                      L3 = trainData$L3_z,
                      S2 = trainData$S2_z,
